...
BayesAimin_6_6_2013<-function(nsb,re_b,ppa_start,testPi, mcmc)
{
    ...
    cat("corrY = ", corrY, "\n")
    #nmarkers = 2000
    #data2 = matrix(scan("testData.out0"), ncol = nmarkers + 2,
    #    byrow = TRUE)
    #nrecords = dim(data2)[1]
    #startMarker = 1
    #t_x = cbind(1, data2[, startMarker:nmarkers])
    #t_y = data2[, nmarkers + 1]
    #a = data2[, nmarkers + 2]
    #aHat = t_x %*% meanb
    return(results)
}
